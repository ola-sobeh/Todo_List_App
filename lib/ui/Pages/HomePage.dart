...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
            ...
            body: Consumer<AddTaskProvider>(builder: (context, provider, x) {
                        ...
                        child: Row(
                          children: [
                            CircularPercentIndicator(
                              ...
                              center: Text(
                                (provider.getProgressPercentage()).toStringAsFixed(1)+"%",
                                style:  TextStyle(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      "${provider.totalCompleteTask}/${provider.totalTaskNum} tasks done ",
                            ...
                            itemBuilder: (context, index) {
                              return Dismissible(
                                ...
                                secondaryBackground:Container(
                                  color:Colors.red,
                                  child: Align(child: Icon(Icons.cancel ,color: Colors.black)
